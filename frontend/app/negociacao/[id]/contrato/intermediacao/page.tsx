...
export default async function ContratoIntermediacaoPage({ params }: PageProps) {
    ...
    return (
      <main style={pageBg}>
        <div style={shell}>
          ...
          <div style={card}>
            <h1 style={title}>Contrato de intermediação não encontrado</h1>
            <p style={muted}>
              Ainda não existe contrato de intermediação salvo para esta negociação.
            </p>
          </div>
        </div>
      </main>
      ...
      <div style={shell}>
        ...
        <div style={heroCard}>
          <div>
            ...
            <h1 style={heroTitle}>Contrato de Intermediação Digital IMOBAI</h1>
            <p style={muted}>
