...
export default async function ContratoPropostaPage({ params }: PageProps) {
    ...
    return (
      <main style={pageBg}>
        <div style={shell}>
          ...
          <div style={card}>
            <h1 style={title}>Proposta não encontrada</h1>
            <p style={muted}>
              Ainda não existe proposta formal salva para esta negociação.
            </p>
          </div>
        </div>
      </main>
  ...
  return (
    <main style={pageBg}>
      <div style={shell}>
        ...
        <div style={heroCard}>
          <div>
            <div style={pill}>PROPOSTA DA NEGOCIAÇÃO</div>
            <h1 style={heroTitle}>Proposta de Compra IMOBAI</h1>
            <p style={muted}>
        ...
        <div style={contentCard}>
          <h2 style={sectionTitle}>Conteúdo da proposta</h2>
